...
class Reservation {
    ...
    get info() {
        return `Fecha: ${this.date.toLocaleString()}, ${this.customer.info}, Número de comensales: ${this.guests}`;
    }
    ...
    render() {
        ...
        this.reservations.forEach((reservation) => {
            ...
            reservationCard.innerHTML = `
                <p class="subtitle has-text-primary">Reserva ${reservation.id} - ${reservation.date.toLocaleString()}</p>
